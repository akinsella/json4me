...
import org.json.me.util.StringWriter;
...
public class JSONTest extends TestCase {
	...
	// JSONTestObject is a typical class that implements JSONString.        
    class JSONTestObject implements JSONString {
    	public String aString;
    	public double aNumber;
    	public boolean aBoolean;
    	
        public JSONTestObject(String string, double n, boolean b) {
            this.aString = string;
            this.aNumber = n;
            this.aBoolean = b;
        }
 ...
 //       	JSONTestObject obj = new JSONTestObject("A string, a number, and a boolean", 42, true);
    ...
    private JSONStringer prepareJSONStringer() throws JSONException {
    	JSONTestObject obj = new JSONTestObject("A string, a number, and a boolean", 42, true);
    ...
    public void testJSON3() throws JSONException {
    	JSONStringer jj = prepareJSONStringer();
    	
        System.out.println(jj.toString());
    }
    
    public void testJSON4() throws JSONException {
        JSONObject j;
        JSONArray a;

        JSONStringer jj = prepareJSONStringer();
        System.out.println("JSONStringer: ***" + jj.toString() + "***");
    ...
    public void testJSON5() throws JSONException {
        Enumeration it;
        String s;
    ...
    public void testJSON6() throws JSONException {
        JSONObject j;
        JSONArray a;
        ...
        try {
            ...
            fail("Double test exception failed");
                    } catch (Exception e) {
        ...
        try {
            ...
            fail("Null key test exception failed");
        } catch (Exception e) {
            System.out.println(e);
        }
        System.out.print("Exception: ");
        try {
            ...
            fail("0 double test exception failed");
        } catch (Exception e) {
            System.out.println(e);
        }
        System.out.print("Exception: ");
        try {
            ...
            fail("Negative Test exception failed");
        } catch (Exception e) {
            System.out.println(e);
        }
        ...
        try {
            ...
            fail("NaN Test exception failed");
        } catch (Exception e) {
            System.out.println(e);
        }
    }
